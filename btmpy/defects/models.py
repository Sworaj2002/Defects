...
class Defects_details(models.Model):
...
class Defect_Screen_Shots(models.Model):
    defect = models.ForeignKey(Defects_details,on_delete=models.CASCADE)
    defect_img = models.ImageField(upload_to='defectimg',blank=True,null=True)
